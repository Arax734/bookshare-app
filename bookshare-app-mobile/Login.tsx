...
const schema = yup.object().shape({
  email: yup
    ...
    .trim(),
  password: yup.string().required('Pole hasło jest wymagane').min(1, 'Hasło nie może być puste'),
});
...
export default function Login() {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      let errorMsg = 'Nieprawidłowy email lub hasło';
      ...
      switch (error.code) {
        ...
        case 'auth/invalid-credential':
          errorMsg = 'Niepoprawne dane logowania';
          break;
        case 'auth/too-many-requests':
          errorMsg = 'Zbyt wiele nieudanych prób logowania. Spróbuj ponownie później';
          break;
        case 'auth/user-disabled':
          errorMsg = 'To konto zostało zablokowane';
          break;
        default:
          errorMsg = `Błąd logowania: ${error.message}`;
      }
